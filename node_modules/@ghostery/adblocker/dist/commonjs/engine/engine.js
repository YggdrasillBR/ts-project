...
const cosmetic_js_2 = __importStar(require("./bucket/cosmetic.js"));
...
class FilterEngine extends events_js_1.EventEmitter {
    ...
    static merge(engines, { skipResources = false, overrideConfig = {}, } = {}) {
        ...
        const configKeysMustMatch = Object.keys(config).filter(function (key) {
            return (typeof config[key] === 'boolean' &&
                !compatibleConfigKeys.includes(key) &&
        ...
        const engine = new this({
            ...
            preprocessors,
            lists,
            config: new config_js_1.default({ ...config, ...overrideConfig }),
        });
    ...
    injectCosmeticFilters(filters, { url, injectStyles = true, injectScriptlets, injectExtended, injectPureHasSafely, allowGenericHides = true, getBaseRules, hidingStyle, }) {
        ...
        for (const filter of pureHasFilters) {
            styles += `\n\n${(0, cosmetic_js_2.createStylesheet)([filter.getSelector()], filter.hasCustomStyle() ? filter.getStyle() : hidingStyle)}`;
        }
    ...
    url, hostname, domain, 
    // DOM information
    classes, hrefs, ids, getRulesFromDOM = true, getRulesFromHostname = true, getInjectionRules, getExtendedRules, getPureHasRules, callerContext, }) {
        domain || (domain = '');
