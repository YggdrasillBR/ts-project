...
export declare const ENGINE_VERSION = 704;
...
export default class FilterEngine extends EventEmitter<EngineEventHandlers> {
     ...
     */
    getCosmeticsFilters({ url, hostname, domain, classes, hrefs, ids, getBaseRules, getInjectionRules, getExtendedRules, getRulesFromDOM, getRulesFromHostname, injectPureHasSafely, hidingStyle, callerContext, }: {
        url: string;
        hostname: string;
     ...
     */
    injectCosmeticFilters(filters: CosmeticFilter[], { url, injectStyles, injectScriptlets, injectExtended, injectPureHasSafely, allowGenericHides, getBaseRules, hidingStyle, }: {
        url: string;
    ...
    matchCosmeticFilters({ url, hostname, domain, classes, hrefs, ids, getRulesFromDOM, getRulesFromHostname, getInjectionRules, getExtendedRules, getPureHasRules, callerContext, }: {
        url: string;
        hostname: string;
        domain: string | null | undefined;
        classes?: string[] | undefined;
