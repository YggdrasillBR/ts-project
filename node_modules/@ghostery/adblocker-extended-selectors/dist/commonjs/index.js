...
exports.isPureHasSelector = isPureHasSelector;
...
const extended_js_2 = require("./extended.js");
const parse_js_2 = require("./parse.js");
// check if extended selector consists of :has extended pseudo-classes only
function isPureHasSelector(selector) {
    const ast = (0, parse_js_2.parse)(selector);
    try {
        (0, parse_js_2.walk)(ast, (node) => {
            if (node.type === 'pseudo-class' &&
                node.name !== undefined &&
                node.name !== 'has' &&
                extended_js_2.EXTENDED_PSEUDO_CLASSES.has(node.name)) {
